...
namespace osu.Game.Rulesets.Osu.Difficulty
{
    public class OsuDifficultyCalculator : DifficultyCalculator
    {
        ...
        protected override DifficultyAttributes CreateDifficultyAttributes(IBeatmap beatmap, Mod[] mods, Skill[] skills, double clockRate)
        {
            ...
            double basePerformance = DifficultyCalculationUtils.Norm(OsuPerformanceCalculator.PERFORMANCE_NORM_EXPONENT, baseAimPerformance, baseSpeedPerformance, baseRhythmComplexityPerformance, baseCognitionPerformance);
            ...
            OsuDifficultyAttributes attributes = new OsuDifficultyAttributes
            {
                ...
                RhythmComplexityDifficulty = rhythmComplexityRating,
